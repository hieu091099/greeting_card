                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                ...
                                <li><a onclick="chooseLanguage('en')" class="dropdown-item clang"><img src="./assets/images/flags/gb.svg" class="icon-flag" alt="">
                                        <?php echo $english; ?></a></li>
                                <li><a onclick="chooseLanguage('tw')" class="dropdown-item clang"><img src="./assets/images/flags/tw.svg" class="icon-flag" alt="">
                                        <?php echo $taiwanese; ?></a></li>
                                <li><a onclick="chooseLanguage('vn')" class="dropdown-item clang"><img src="./assets/images/flags/vn.svg" class="feather icon-flag" alt="">
