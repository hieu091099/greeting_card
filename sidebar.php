		...
		<div class="navbar-wrapper ">
			<div class="navbar-brand header-logo">
				<a href="index.php" class="b-brand">
                    ...
                    <div class="logo-thumb images"><a href="#!"><i class="fa fa-align-justify text-w-info f-30"></i></a></div>
				</a>
			...
			<div class="navbar-content scroll-div">
				<ul class="nav pcoded-inner-navbar">
					...
					<li class="nav-item">
						<a href="index.php" class="nav-link"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext"><?php echo $dash_board; ?></span></a>
					</li>
                    <li class="nav-item">
						<a href="./modules/customer.php" class="nav-link"><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext"><?php echo $customer; ?></span></a>
					</li>
					<!-- <li class="nav-item pcoded-menu-caption">
						<label>UI Element</label>
					</li> -->
					<li class="nav-item pcoded-hasmenu">
						<a  class="nav-link"><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext"><?php echo $greeting_card; ?></span></a>
                    ...
                    <li class="nav-item pcoded-hasmenu">
						<a  class="nav-link"><span class="pcoded-micon"><i class="feather icon-mail"></i></span><span class="pcoded-mtext"><?php echo $mail; ?></span></a>
						<ul class="pcoded-submenu">
                    ...
                    <li class="nav-item pcoded-hasmenu">
						<a  class="nav-link"><span class="pcoded-micon"><i class="feather icon-settings"></i></span><span class="pcoded-mtext"><?php echo $system; ?></span></a>
						<ul class="pcoded-submenu">
						...
						<div class="dropdown-menu dropdown-menu-right notification">
							...
							<ul class="noti-body">
								...
								<li class="notification">
									<div class="media">
										<img class="img-radius" src="./assets/images/user_avatar.jpg" alt="Generic placeholder image">
					...
					<div class="dropdown drp-user">
						...
						<div class="dropdown-menu dropdown-menu-right profile-notification">
							...
							<ul class="pro-body">
                                ...
                                <li><a onclick="chooseLanguage('en')" class="dropdown-item clang"><img src="./assets/images/flags/gb.svg" class="icon-flag" alt=""> <?php echo $english; ?></a></li>
								<li><a onclick="chooseLanguage('tw')" class="dropdown-item clang"><img src="./assets/images/flags/tw.svg" class="icon-flag" alt=""> <?php echo $taiwanese; ?></a></li>
								<li><a onclick="chooseLanguage('vn')" class="dropdown-item clang"><img src="./assets/images/flags/vn.svg" class="feather icon-flag" alt=""> <?php echo $vietnamese; ?></a></li>
							</ul>
						</div>
					</div>
				</li>
